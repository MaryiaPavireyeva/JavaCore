...
public class Main1 {
    ...
    /**
     * метод, который считает все слова в тексте и помещает их в сэт пункт №2
     *
...
//читаем файл, разделяем на слова, помещаем в массив и все получившиеся массивы добавляем в Сэт
    ...
    /**
     * метод, который ищет кол-во повторений слов в Мапе и сортирует по самомым топовым повторениям пункт №2,2
     *
     * @param path путь до файла
     * @throws IOException
     */
